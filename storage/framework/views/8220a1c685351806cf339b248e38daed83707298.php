...
<body class="hold-transition <?php echo e(config('backpack.base.skin')); ?> sidebar-mini">
      ...
      <footer class="main-footer">
        <?php if(config('backpack.base.show_powered_by')): ?>
            <div class="pull-right hidden-xs">
              <?php echo e(trans('backpack::base.powered_by')); ?> <a target="_blank" href="http://laravelbackpack.com">Laravel BackPack</a>
            </div>
        <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        var current_url = "<?php echo e(url(Route::current()->getUri())); ?>";
