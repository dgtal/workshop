      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="http://placehold.it/160x160/00a65a/ffffff/&text=<?php echo e(Auth::user()->name[0]); ?>" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="<?php echo e(url('admin/order')); ?>"><i class="fa fa-wrench"></i> <span>Órdenes</span></a></li>
          <!-- ======================================= -->
