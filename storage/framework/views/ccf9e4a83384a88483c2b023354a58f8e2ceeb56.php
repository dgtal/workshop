        ...
        <table id="crudTable" class="table table-bordered table-striped display">
            <thead>
              <tr>
                ...
                <?php $__currentLoopData = $crud->columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            ...
            <tbody>
              ...
              <?php if(!$crud->ajaxTable()): ?>
                <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $entry): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
	...
	<script type="text/javascript">
      ...
      <?php endif; ?>
        ...
        "language": {
          ...
          "serverSide": true,
          "ajax": {
              "url": "<?php echo e(url($crud->route.'/search').'?'.Request::getQueryString()); ?>",
              "type": "POST"
          },
          <?php endif; ?>
