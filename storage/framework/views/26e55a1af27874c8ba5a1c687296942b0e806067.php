    ...
    <select
        ...
        <?php endif; ?>
            ...
            <?php if(count($entity_model::getPossibleEnumValues($field['name']))): ?>
                <?php $__currentLoopData = $entity_model::getPossibleEnumValues($field['name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $possible_value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
